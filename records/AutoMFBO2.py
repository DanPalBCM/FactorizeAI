...
if Toydata_maintest:
    ...
    X_scaled = datasets.load_iris().data
    ...
    # Wine dataset
    X_scaled = datasets.load_wine().data
    clusters = [0] # placeholder for non supervised modes
    ...
    X_scaled = datasets.load_breast_cancer().data
    clusters = [0] # placeholder for non supervised modes
...
Samplegeneratordata_maintest = False

from sklearn.datasets import make_swiss_roll
if Samplegeneratordata_maintest == True:
    ...
    X, clusters = make_swiss_roll(n_samples=1500, hole=True, random_state=0)
...
Simulateddata_maintest = False

if Simulateddata_maintest == True:
...
if heatmap_results_table == True:
    ...
    fig = plot.get_figure()
    fig.savefig("results/heatmap_methods.png")

testing_visualizations = False

if testing_visualizations == True:
    """
    Testing clustering visualizations
    """
...
additional_datasetstoy = False

if additional_datasetstoy == True:
    ...
    Model_auto_select(X_moons, clusters, number_clusters, mode, evaluation_method, visualizations = True, name = "moons", random_state = 0)
    ...
    Model_auto_select(X_circles, clusters, number_clusters, mode, evaluation_method, visualizations = True, name = "circles", random_state = 0)
...
additional_datasetstoy2 = False

if additional_datasetstoy2 == True:
    from sklearn import datasets
    ...
    # X = mnist.data
    # y = mnist.target
    # # Initialize variables to store the subset data and labels
    # subset_X = []
    # subset_y = []
    
    # # Define the number of samples you want from each class
    # samples_per_class = 100  # 180 samples for each of the 10 classes
    
    # # Loop through each class and select random samples
    ...
    # # Convert the subset data and labels to NumPy arrays
    ...
    # Model_auto_select(X_scaled, clusters, number_clusters, mode, evaluation_method, visualizations = True, name = "MNIST", random_state = 0) 


toyclusteringmap = True
...
if toyclusteringmap == True:
    ...
    plt.savefig("clusteringmatrix.png",dpi = 1200, transparent = True)
