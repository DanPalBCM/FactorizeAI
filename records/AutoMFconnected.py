...
def Supervised_Consensus(MFiters, method, X_scaled, clusters, mode, evaluation_method, visualizations, **kwargs):
    '''
...
def Initial_Guess(X_scaled, method_list, clusters, mode, evaluation_method, visualizations,  **kwargs):
    '''
    ...
    for method in method_list:
        score = Supervised_Consensus(MFiters, method, X_scaled, clusters, mode, evaluation_method, visualizations, **kwargs) 
...
def Model_auto_select(X, clusters, mode, evaluation_method, visualizations, **kwargs):
    """
    ...
    if (X >= 0).all():
        ...
        optimal_model = Initial_Guess(X, method_list, clusters, mode, evaluation_method, visualizations,  **kwargs)
...
def Model_optimization(X, clusters, optimal_model, mode, evaluation_method, visualizations):
    print(optimal_model) 
    if optimal_model == "PCA_sklearn":
        ...
        for i in range(len(n_components_list)):
            for j in range(len(svd_solver_list)):
                ...
                if mode == "Supervised" or mode == "Unsupervised":
                    labels = Ensemble_classifier_sklearn(W, 2)
        ...
        if mode == "Supervised" or mode == "Unsupervised":
            o_labels = Ensemble_classifier_sklearn(oW, 2)
        else:
            o_labels = [0]
    ...
    if optimal_model == "MiniBatch_NMF":
        ...
        for i in range(len(n_components_list)):
            for j in range(len(init_list)):
                ...
                model = MiniBatchNMF(n_components = n_components_list[i], init = init_list[j])
                W = model.fit_transform(X)
        ...
        o_model = MiniBatchNMF(n_components = n_components_list[min_index[0]], init = init_list[min_index[1]])
    ...
    if optimal_model == "Kernel_PCA":
        ...
        for i in range(len(n_components_list)):
            for j in range(len(kernel_list)):
                ...
                model = KernelPCA(fit_inverse_transform = True, n_components = n_components_list[i], kernel = kernel_list[j])
                W = model.fit_transform(X)
        ...
        o_model = KernelPCA(fit_inverse_transform = True, n_components = n_components_list[min_index[0]], kernel = kernel_list[min_index[1]])
    ...
    if optimal_model == "Truncated_SVD":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = TruncatedSVD(n_components = param1_list[i], power_iteration_normalizer = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = TruncatedSVD(n_components = param1_list[min_index[0]], power_iteration_normalizer = param2_list[min_index[1]])
    ...
    if optimal_model == "IndependentCA":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = FastICA(n_components = param1_list[i], fun = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = FastICA(n_components = param1_list[min_index[0]], fun = param2_list[min_index[1]])
    ...
    if optimal_model == "Sparse_PCA":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = SparsePCA(n_components = param1_list[i], method = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = SparsePCA(n_components = param1_list[min_index[0]], method = param2_list[min_index[1]])
    ...
    if optimal_model == "MiniBatch_SparsePCA":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = MiniBatchSparsePCA(n_components = param1_list[i], method = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = MiniBatchSparsePCA(n_components = param1_list[min_index[0]], method = param2_list[min_index[1]])
    ...
    if optimal_model == "Factor_Analysis":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = FactorAnalysis(n_components = param1_list[i], svd_method = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = FactorAnalysis(n_components = param1_list[min_index[0]], svd_method = param2_list[min_index[1]])
    ...
    if optimal_model == "Dictionary":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = DictionaryLearning(max_iter = 10, n_components = param1_list[i], transform_algorithm = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = DictionaryLearning(max_iter = 10, n_components = param1_list[min_index[0]], transform_algorithm = param2_list[min_index[1]])
    ...
    if optimal_model == "LDA":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = LatentDirichletAllocation(n_components = param1_list[i], learning_method = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = LatentDirichletAllocation(n_components = param1_list[min_index[0]], learning_method = param2_list[min_index[1]])
    ...
    if optimal_model == "t_SNE":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = TSNE(n_components = param1_list[i], method = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = TSNE(n_components = param1_list[min_index[0]], method = param2_list[min_index[1]])
    ...
    if optimal_model == "Local_Linear_Embedding":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = LocallyLinearEmbedding(n_neighbors = 25, n_components = param1_list[i], method = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = LocallyLinearEmbedding(n_neighbors = 25, n_components = param1_list[min_index[0]], method = param2_list[min_index[1]])
    ...
    if optimal_model == "Multidimensional_scaling":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = MDS(n_components = param1_list[i], dissimilarity = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = MDS(n_components = param1_list[min_index[0]], dissimilarity = param2_list[min_index[1]])
    ...
    if optimal_model == "Spectral_Embedding":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = SpectralEmbedding(n_components = param1_list[i], eigen_solver = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = SpectralEmbedding(n_components = param1_list[min_index[0]], eigen_solver = param2_list[min_index[1]])
    ...
    if optimal_model == "U_MAP":
        ...
        for i in range(len(param1_list)):
            for j in range(len(param2_list)):
                ...
                model = umap.UMAP(n_components = param1_list[i], n_neighbors = param2_list[j])
                W = model.fit_transform(X)
        ...
        o_model = umap.UMAP(n_components = param1_list[min_index[0]], n_neighbors = param2_list[min_index[1]])
...
def AutoMF_main(X, clusters, mode, evaluation_method, visualizations, **kwargs):

    optimal_model = Model_auto_select(X, clusters, mode, evaluation_method, visualizations, **kwargs)

    optimal_finetuned_model, X_transformed, clustering_labels = Model_optimization(X, clusters, str(optimal_model["method"].tolist()[0]), mode, evaluation_method, visualizations)
...
def maintest():
    ...
    AutoMF_main(X, clusters, mode = "Supervised", evaluation_method = "adjusted_rand_score", visualizations = False,
            n_components = 2, random_state = None)

    AutoMF_main(X, clusters, mode = "Unsupervised", evaluation_method = "silhouette", visualizations = True,
            n_components = 2, random_state = None)

    AutoMF_main(X, clusters, mode = "Reconstruction", evaluation_method = "MSE", visualizations = False,
            n_components = 2, random_state = None)
...
def Simulateddata_maintest():
    ...
    AutoMF_main(X, clusters, mode = "Unsupervised", evaluation_method = "silhouette",
            visualizations = False, n_components = 2, random_state = None)
...
def Supervised_test():
    ...
    AutoMF_main(X, clusters, mode = "Supervised")
...
def Hyper_test():
    ...
    #Model_optimization(X, clusters, optimal_model, "Reconstruction", "MSE")
        Model_optimization(X, clusters, optimal_model, "Supervised", "adjusted_rand_score")
    #Model_optimization(X, clusters, optimal_model, "Unsupervised", "silhouette")
    
    Model_optimization(np.absolute(X), clusters, "NMF_sklearn", "Supervised", "adjusted_rand_score")
    Model_optimization(np.absolute(X), clusters, "MiniBatch_NMF", "Supervised", "adjusted_rand_score")
    Model_optimization(np.absolute(X), clusters, "LDA", "Supervised", "adjusted_rand_score")
